...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AjaxUploader = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IframeUploader = _react2['default'].createClass({
	  ...
	  getIframeNode: function getIframeNode() {
	    return _react2['default'].findDOMNode(this.refs.iframeContainer).getElementsByTagName('iframe')[0];
	  },
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('span', { ref: 'iframeContainer' }),
	      this.props.children
	    );
	  },
	
	  createIframeNodeIn: function createIframeNodeIn(iframeContainer, src) {
	  ...
	  initIframe: function initIframe(callback) {
	    var _this2 = this;
	
	    var writeIframeContent = function writeIframeContent() {
	      var win = iframeNode.contentWindow;
	      var doc = win.document;
	      doc.open('text/html', 'replace');
	      doc.write(_this2.getIframeHTML());
	      doc.close();
	      _this2.getFormInputNode().onchange = _this2.onChange;
	      callback && callback();
	    };
	    var iframeContainer = _react2['default'].findDOMNode(this.refs.iframeContainer);
	    var iframeNode = this.createIframeNodeIn(iframeContainer);
	    setTimeout(function () {
	      try {
	        iframeNode.contentWindow.document.write('try');
	      } catch (e) {
	        iframeContainer.removeChild(iframeNode);
	        iframeNode = _this2.createIframeNodeIn(iframeContainer, "javascript:void((function(){var d=document;d.open();d.domain='" + document.domain + "';d.write('');d.close()})())");
